...
Label1 = Label(root,text= "WELCOME TO CRIMINAL DATABASE",font=("Algerian",18,"bold"),fg = "grey",relief = GROOVE)
...
def submitt(x, y):	
	...
	try:	
		if pwd[0] == y:
			...
			Label3 = Label(top,text="wrong pwd/username try again",font ="ALGERIAN ",fg='black').pack(fill=BOTH)	
...
def loginn():
    ...
    Label1 = Label(top,text="USERNAME : ",font=("Felix Titling",12,"bold"), fg = '#554540')
    Label1.place(x=150,y=150)
    var1=StringVar()
    Entry1=Entry(top,text=var1)
    Entry1.place(x=300,y=150)
    Label2 = Label(top,text="PASSWORD : ",font=("Felix Titling",12,"bold"),fg='#554540')
    ...
    b2 = Button(top,text="SUBMIT",fg='black',command= lambda: submitt(Entry1.get(), Entry2.get()))
...
def log():
    l1 = Label(root1,text="WELCOME TO OUR SERVER!!",font=("Alegrian",15,'bold')).pack()
    con = ms.connect(host ='localhost',user = 'root', passwd='yog14', database ='project')
    cursor = con.cursor()                   
...
def register():
    ...
    Label1 = Label(root1,text="Enter Your Name : ",font=("Felix Titling",11,"bold")).pack()
    a1=StringVar()
    Entry1 = Entry(root1,text =a1)
    Entry1.pack()
    Label2 = Label(root1,text="Enter Password : ",font = ("Felix Titling",11,'bold')).pack()
    a2 = StringVar()
    Entry2 = Entry(root1,text=a2,show="*")
    Entry2.pack()
    a3=StringVar() 
    Label3 = Label(root1,text ="DOB:",font=('Felix Titling',11,'bold')).pack()
    Entry3 = Entry(root1,text =a3)
    Entry3.pack()
    Label5 = Label(root1,text = "AGE",font = ("Felix Titling",11,"bold")).pack()
    a5 = StringVar()
    Entry5 = Entry(root1,text=a5)
    Entry5.pack()
    Label6 = Label(root1,text = "EXPERIENCE",font = ("Felix Titling",11,"bold")).pack()
    a6 = StringVar()
...
Button1 = Button(root,text="LOGIN",font="Algerian",fg='black',bg='white',relief=RIDGE,command=loginn)
Button1.place(x=225,y=370)
               
Button2 = Button(root,text ="EXIT",font="Algerian",fg ='black',bg='white',relief=RIDGE,command=quitt)
Button2.place(x=125,y=370)


Button3 = Button(root,text="SIGN UP",font="Algerian",fg ='black',bg='white',relief=RIDGE,command =register)
Button3.place(x=325,y=370)

Button4 = Button(root,text="Continue as guest",font="Algerian",fg ='black',bg='white',relief=RIDGE,command =gt)
